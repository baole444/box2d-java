...
public class _float_const {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.sequenceLayout(4, Box2D.C_SHORT).withName("_Word"),
        Box2D.C_FLOAT.withName("_Float"),
        Box2D.C_DOUBLE.withName("_Double"),
        Box2D.C_LONG_DOUBLE.withName("_Long_double")
