...
public class b2ShapeProxy {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, b2Vec2.layout()).withName("points"),
    ...
    private static long[] points$DIMS = { 8 };
    ...
    public static void points(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, points(struct, index0), 0L, b2Vec2.layout().byteSize());
    }
